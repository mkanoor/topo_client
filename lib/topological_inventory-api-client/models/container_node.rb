...
module TopologicalInventoryApiClient
  class ContainerNode
    ...
    def hash
      [archived_at, cpus, created_at, id, last_seen_at, lives_on_id, lives_on_type, memory, name, resource_version, source_created_at, source_deleted_at, source_id, source_ref, updated_at].hash
    end
